...
object Constants {
    ...
    const val REQUEST_CODE_GOOGLE_SIGN_IN = 99
    ...
    const val REQUEST_CODE_GALLERY_PROFILE_PHOTO = 1
    ...
    const val REQUEST_CODE_GALLERY_GROUP = 1
    const val REQUEST_CODE_CAMERA_GROUP = 2
}